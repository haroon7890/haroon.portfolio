...
export default function Footer() {
  return (
    <footer className="bg-[color:var(--page-bg)] border-t border-[color:var(--border)] py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col items-center md:items-start gap-1">
<span className="font-mono font-semibold text-[color:var(--accent)] text-sm">haroon.dev</span>
          <span className="text-xs text-[color:var(--text-dim)]">Full-Stack Engineer & AI Integrator</span>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            ...
            className="inline-flex items-center justify-center text-[color:var(--text-dim)] hover:text-[color:var(--accent)] transition-colors duration-200"
            aria-label="GitHub"
          >
          ...
          <a
            href="https://linkedin.com/in/haroon-imran"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center text-[color:var(--text-dim)] hover:text-[color:var(--accent)] transition-colors duration-200"
            aria-label="LinkedIn"
        ...
        <div className="flex flex-col items-center md:items-end gap-1">
          <span className="text-xs text-[color:var(--text-dim)]">Built with Next.js & Tailwind CSS</span>
          <span className="text-xs text-[color:var(--text-dim)]">© 2025 Haroon Imran</span>
        </div>
      </div>
    </footer>
  );
